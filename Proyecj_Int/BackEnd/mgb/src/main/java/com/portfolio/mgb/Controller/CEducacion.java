...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        if (sEducacion.existsByNombreE(dtoeducacion.getNombreE())){
            return new ResponseEntity(new Mensaje("ese nombre ya es existente"), HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(sEducacion.existsByNombreE(dtoeducacion.getNombreE())&& sEducacion.getByNombreE(dtoeducacion.getNombreE()).get().getId() !=id){
            return new ResponseEntity(new Mensaje("Ese nombre ya esta existente"), HttpStatus.BAD_REQUEST);
        }
        if(sEducacion.existsByNombreE(dtoeducacion.getDescripcionE())&& sEducacion.getByNombreE(dtoeducacion.getDescripcionE()).get().getId() !=id){
            return new ResponseEntity(new Mensaje("Esa descripcion ya esta existente"), HttpStatus.BAD_REQUEST);
        }
        if(StringUtils.isBlank(dtoeducacion.getNombreE())){
        ...
        return new ResponseEntity(new Mensaje("Educacion de usuario actualizada correctamente"), HttpStatus.OK);
    }
}
